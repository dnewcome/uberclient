...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.Control', {
		Control : function(id, s, editor) {
			...
			this.settings = s = s || {};
			this.rendered = false;
			this.onPostRender = new tinymce.util.Dispatcher(this);			
			this.classPrefix = '';
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		Editor : function(id, s) {
			...
			// do user_dom_events
			each(s.user_dom_events,function(dispatch_name,dom_event) {
				t[dispatch_name] = new Dispatcher(t);
			});
		...
		_addEvents : function() {
			...
			var t = this, i, s = t.settings, dom = t.dom, lo =  lo = extend(s.user_dom_events, {
				mouseup : 'onMouseUp',
